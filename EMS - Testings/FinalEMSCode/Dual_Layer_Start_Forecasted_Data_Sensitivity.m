...
%%%%%% upper layer eka add karanna ona
...
for k=1:Nday
    ...
    w1 = 1;      % deviation from base
    w2 = 3;      % smoothness weight (bigger = smoother)
    w3 = 0.2;    % phi penalty
    
    % decision = [Timp, phi, s1, s2]
    f_up = [0; w3; w1; w2];
    ...
    % inequalities
    A_up = [
        1  0  -1   0;   % Timp - Tbase <= s1
        -1  0  -1   0;
        
        1  0   0  -1;   % Timp - Tprev <= s2
        -1  0   0  -1
        ];
