...
% Legend
legend(arrayfun(@(x) sprintf('Pole %d',x), 1:14, 'UniformOutput', false), ...
...
figure
plot(V_pu(:,1), 'LineWidth', 1.5)
hold on
plot(V_pu(:,14), 'LineWidth', 1.5)

xlabel('Time Step')
ylabel('Voltage (pu)')
title('Voltage Comparison: Pole 1 vs Pole 14')
...
legend('Pole 1','Pole 14','Location','best')
...
Pgrid_max_export = 97.8;  % export limit
...
filename = '1 Fixed_Fixed_Fixed/MPC_Results_Fixed_Fixed_Fixed.xlsx';
